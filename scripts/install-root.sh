...
# StreamHib Node.js Auto Installation Script for Ubuntu 22.04 (ROOT)
# Repository: https://github.com/gawemegae/streamhibnodejs

set -e

echo "🚀 StreamHib Node.js Auto Installation Script (ROOT)"
echo "===================================================="
...
ufw allow 80
ufw allow 443
print_status "Firewall rules added. Enable with: ufw --force enable"
ufw --force enable
